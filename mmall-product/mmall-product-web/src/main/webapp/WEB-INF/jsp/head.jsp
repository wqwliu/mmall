...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/lib/css/base.min.css" />

    <link rel="stylesheet" href="${pageContext.request.contextPath}/lib/css/list.min.css" />
...
<div class="site-topbar">
    <div class="container">
        ...
        <div class="topbar-info" id="J_userInfo">
            ...
            <c:if test="${!empty user }">
                <a href="${pageContext.request.contextPath}/showUser"><span>欢迎您：${user}</span></a>
            </c:if>
                                ...
                                <li class="first">
                                    <div class="figure figure-thumb">
                                        <a href="https://www.mi.com/mi8/"><img
                                                src="${pageContext.request.contextPath}/lib/picture/placeholder-220!110x110.png"
                                ...
                                <li>
                                    <div class="figure figure-thumb">
                                        <a href="https://www.mi.com/mibookpro-gtx/?cfrom=search">
                                            <img src="${pageContext.request.contextPath}/lib/picture/placeholder-220!110x110.png"
                    ...
                    <div class="item-children">
                        <div class="container">
                            <ul class="children-list clearfix">
                                ...
                                <li>
                                    <div class="figure figure-thumb">
                                        <a href="//search.mi.com/search_路由器-29"><img
                                                src="${pageContext.request.contextPath}/lib/picture/placeholder-220!110x110.png"
                                    ...
                                    <div class="title">
                                        <a href="//search.mi.com/search_路由器-29">查看全部小米路由器</a>
                                    </div>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="header-search">
            <form id="J_searchForm" class="search-form clearfix" action="//localhost:83/search/searchProduct" method="get">
                ...
                <div class="search-hot-words">
                    <a href="https://www.mi.com/mi8/">小米8</a>
                    <a href="https://item.mi.com/product/10000085.html">小米MIX 2S</a>
                </div>
            </form>
        </div>
    </div>
...
<div class="breadcrumbs">
    <div class="container">
        ...
        <a href="//search.mi.com/search_小米6x">全部结果</a><span class="sep">&gt;</span><span>小米6x</span> </div>
</div>


<%--<script src="${pageContext.request.contextPath}/lib/js/base.min.js"></script>--%>
<script>
    (function () {
...
<script src="${pageContext.request.contextPath}/lib/js/goodslist.min.js"></script>
<script>
    var _msq = _msq || [];

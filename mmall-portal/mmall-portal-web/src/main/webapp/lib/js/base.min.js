    ...
    !function (e) {
        function t(e) {
            for (var t = "", n = 0, i = e.length; i > n; n += 1) {
                var r, o;
                "object" == typeof e[n] ? (r = e[n].Key.replace(f, '<span class="keyword">' + f + "</span> "), o = e[n].Rst ? '<span class="result">约有' + e[n].Rst + "件</span>" : "", t += '<li data-key="' + e[n].Key + '"><a href="//localhost:83/search/searchProduct?keyWord=' + encodeURIComponent(e[n].Key) + '">' + r + o + "</a></li>") : (r = e[n].replace(f, '<span class="keyword">' + f + "</span> "), o = "", t += '<li data-key="' + e[n] + '"><a href="//localhost:83/search/searchProduct?keyWord=' + encodeURIComponent(e[n]) + '">' + r + o + "</a></li>")
            }

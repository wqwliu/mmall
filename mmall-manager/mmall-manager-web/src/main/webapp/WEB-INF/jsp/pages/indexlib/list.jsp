...
<script type="text/javascript">
    ...
    layui.use(['table', 'admin', 'jquery', 'layer','form'], function () {
        ...
        var table1=table.render({
            ...
            elem: '#articleList',
            //异步请求
            url: '../../admin/index/getlimagelist',
            //列
            cols: [[
                //field title 列属性
                {field: 'iid', title: '轮播图id',width: 130, sort: true},
                //{field: '', title: '轮播图id',width: 300, sort: true},
                {field: 'idesc', title: '轮播图描述',width: 150, sort: true},
                {field: 'image', title: '轮播图地址',width: 193,sort: true,edit:'text'},
                {field: 'pname', title: '商品名',width: 180,sort: true,edit:'text'},
                {field: 'address', title: '目标地址',width: 149,sort: true,edit:'text'},
                {field: 'sort', title: '排序值',width: 100,sort: true,edit:'text'},
...
//                );
        ...
        table.on('tool(dataTable)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
            ...
            if(obj.event === 'del'){
                ...
                _add('编辑'+thisTitle,'../../admin/index/getlimage?iid='+data.iid);
        ...
        function _acDel(iid) {
            $.ajax({
                url: '../../admin/index/limage/delete?iid='+iid,
                type: "get",
                dataType: "json",

...
<div class="weadmin-body">
    <form class="layui-form">
        ...
        <div class="layui-form-item layui-form-text">
            <label for="sellPoint" class="layui-form-label">轮播图描述</label>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="priceView" name="pname" value="${aabbcc.pname}" required="" lay-verify="number" autocomplete="off"
                       class="layui-input">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="num" name="pid" required="" value="${aabbcc.pid}" lay-verify="number" autocomplete="off"
                       class="layui-input">
                <input type="hidden" name="iid" value="${aabbcc.iid}">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="barcode" name="sort" required=""  value="${aabbcc.sort}" lay-verify="required" autocomplete="off"
                       class="layui-input">
            </div>
        </div>
        <div class="layui-form-item layui-form-text">
            <label for="" class="layui-form-label">轮播图更新</label>
            <div class="layui-input-block">
                <%--第一步--%>

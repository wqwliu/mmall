!function (e) {
    ...
    !function (t, n) {
        ...
        function D(e, t, n) {
            var i = !0, r = "width" === t ? e.offsetWidth : e.offsetHeight, o = rt(e),
        ...
        function H(e, t, n) {
            var i, r, o, a, s, c, l, u, d = this, f = {}, p = e.style, h = e.nodeType && Le(e),
                g = ce._data(e, "fxshow");
            ...
            if (ce.isEmptyObject(f)) "inline" === ("none" === l ? I(e.nodeName) : l) && (p.display = l); else {
        ...
        function U(e, t, n) {
            ...
            for (J(u, l.opts.specialEasing); a > o; o++) if (i = Ct[o].call(l, e, u, l.opts)) return i;
        ...
        var K = [], Z = K.slice, ee = K.concat, te = K.push, ne = K.indexOf, ie = {}, re = ie.toString,
            oe = ie.hasOwnProperty, ae = {}, se = "1.11.3", ce = function (e, t) {
        ...
        var pe = function (e) {
            ...
            function v(e, t, n, r, o, a) {
                return r && !r[P] && (r = v(r)), o && !o[P] && (o = v(o, a)), i(function (i, a, s, c) {
                    var l, u, d, f = [], p = [], h = a.length, v = i || g(t || "*", s.nodeType ? [s] : s, []),
                        y = !e || !i && t ? v : m(v, f, e, s, c), b = n ? o || (i ? e : h || r) ? [] : a : y;
            ...
            function b(e, n) {
                var r = n.length > 0, o = e.length > 0, a = function (i, a, s, c, l) {
                    var u, d, f, p = 0, h = "0", g = i && [], v = [], y = A, b = i || o && C.find.TAG("*", l),
            ...
            var w, x, C, T, k, _, E, S, A, I, M, N, L, $, j, D, R, B, O, P = "sizzle" + 1 * new Date, H = e.document,
                J = 0, U = 0, F = n(), q = n(), z = n(), W = function (e, t) {
                    return e === t && (M = !0), 0
                }, G = 1 << 31, Y = {}.hasOwnProperty, Q = [], X = Q.pop, V = Q.push, K = Q.push, Z = Q.slice,
                ee = function (e, t) {
                ...
                ye = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, be = /[+~]/, we = /'|\\/g,
                xe = new RegExp("\\\\([\\da-f]{1,6}" + ne + "?|(" + ne + ")|.)", "ig"), Ce = function (e, t, n) {
                    var i = "0x" + t - 65536;
                    ...
                    TAG: function (e) {
                        ...
                        return 1 === i && 0 === r ? function (e) {
                            ...
                            var l, u, d, f, p, h, g = o !== a ? "nextSibling" : "previousSibling", m = t.parentNode,
                                v = s && t.nodeName.toLowerCase(), y = !c && !s;
                            if (m) {
                                if (o) {
                                    for (; g;) {
                                ...
                                if (h = [a ? m.firstChild : m.lastChild], a && y) {
                                    for (u = m[P] || (m[P] = {}), l = u[e] || [], p = l[0] === J && l[1], f = l[0] === J && l[2], d = p && m.childNodes[p]; d = ++p && d && d[g] || (f = p = 0) || h.pop();) if (1 === d.nodeType && ++f && d === t) {
                                        u[e] = [J, p, f];
                                        break
                                    }
                                } else if (y && (l = (t[P] || (t[P] = {}))[e]) && l[0] === J) f = l[1]; else for (; (d = ++p && d && d[g] || (f = p = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== v : 1 !== d.nodeType) || !++f || (y && ((d[P] || (d[P] = {}))[e] = [J, f]), d !== t));) ;
            ...
            return d.prototype = C.filters = C.pseudos, C.setFilters = new d, _ = t.tokenize = function (e, n) {
                ...
                var r, o, a, s, c, l = "function" == typeof e && e, d = !i && _(e = l.selector || e);
                if (n = n || [], 1 === d.length) {
        ...
        ce.Callbacks = function (e) {
            ...
            Deferred: function (e) {
                ...
                var t, n, i, r = 0, o = Z.call(arguments), a = o.length,
                    s = 1 !== a || e && ce.isFunction(e.promise) ? a : 0, c = 1 === s ? e : ce.Deferred(),
                    l = function (e, n, i) {
                        return function (r) {
        ...
        ce.fn.ready = function (e) {
            ...
            if (!_e) if (_e = ce.Deferred(), "complete" === ye.readyState) setTimeout(ce.ready); else if (ye.addEventListener) ye.addEventListener("DOMContentLoaded", d, !1), n.addEventListener("load", d, !1); else {
        ...
        var Me = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source, Ne = ["Top", "Right", "Bottom", "Left"],
            Le = function (e, t) {
        ...
        var De = /^(?:input|select|textarea)$/i, Re = /^key/, Be = /^(?:mouse|pointer|contextmenu)|click/,
            Oe = /^(?:focusinfocus|focusoutblur)$/, Pe = /^([^.]*)(?:\.(.+)|)$/;
        ce.event = {
            global: {},
            ...
            trigger: function (e, t, i, r) {
                var o, a, s, c, l, u, d, f = [i || ye], p = oe.call(e, "type") ? e.type : e,
            ...
            dispatch: function (e) {
                e = ce.event.fix(e);
                var t, n, i, r, o, a = [], s = Z.call(arguments), c = (ce._data(this, "events") || {})[e.type] || [],
        ...
        var He = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video",
            Je = / jQuery\d+="(?:null|\d+)"/g, Ue = new RegExp("<(?:" + He + ")[\\s/>]", "i"), Fe = /^\s+/,
            qe = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, ze = /<([\w:]+)/,
            We = /<tbody/i, Ge = /<|&#?\w+;/, Ye = /<(?:script|style|link)/i, Qe = /checked\s*(?:[^=]|=\s*.checked.)/i,
            Xe = /^$|\/(?:java|ecma)script/i, Ve = /^true\/(.*)/, Ke = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g,
            Ze = {
        ...
        Ze.optgroup = Ze.option, Ze.tbody = Ze.tfoot = Ze.colgroup = Ze.caption = Ze.thead, Ze.th = Ze.td, ce.extend({
            clone: function (e, t, n) {
                ...
                if (ae.html5Clone || ce.isXMLDoc(e) || !Ue.test("<" + e.nodeName + ">") ? o = e.cloneNode(!0) : (tt.innerHTML = e.outerHTML, tt.removeChild(o = tt.firstChild)), !(ae.noCloneEvent && ae.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || ce.isXMLDoc(e))) for (i = w(o), s = w(e), a = 0; null != (r = s[a]); ++a) i[a] && S(r, i[a]);
                if (t) if (n) for (s = s || w(e), i = i || w(o), a = 0; null != (r = s[a]); a++) E(r, i[a]); else E(e, o);
                ...
                for (var r, o, a, s, c, l, u, d = e.length, f = b(t), p = [], h = 0; d > h; h++) if (o = e[h], o || 0 === o) if ("object" === ce.type(o)) ce.merge(p, o.nodeType ? [o] : o); else if (Ge.test(o)) {
                    ...
                    if (!ae.leadingWhitespace && Fe.test(o) && p.push(t.createTextNode(Fe.exec(o)[0])), !ae.tbody) for (o = "table" !== c || We.test(o) ? "<table>" !== u[1] || We.test(o) ? 0 : s : s.firstChild, r = o && o.childNodes.length; r--;) ce.nodeName(l = o.childNodes[r], "tbody") && !l.childNodes.length && o.removeChild(l);
                    for (ce.merge(p, s.childNodes), s.textContent = ""; s.firstChild;) s.removeChild(s.firstChild);
                    s = f.lastChild
                } else p.push(t.createTextNode(o));
                for (s && f.removeChild(s), ae.appendChecked || ce.grep(w(p, "input"), x), h = 0; o = p[h++];) if ((!i || -1 === ce.inArray(o, i)) && (a = ce.contains(o.ownerDocument, o), s = w(f.appendChild(o), "script"), a && _(s), n)) for (r = 0; o = s[r++];) Xe.test(o.type || "") && n.push(o);
                return s = null, f
        ...
        var rt, ot, at = /^margin/, st = new RegExp("^(" + Me + ")(?!px)[a-z%]+$", "i"),
        ...
        var lt = /alpha\([^)]*\)/i, ut = /opacity\s*=\s*([^)]*)/, dt = /^(none|table(?!-c[ea]).+)/,
            ft = new RegExp("^(" + Me + ")(.*)$", "i"), pt = new RegExp("^([+-])=(" + Me + ")", "i"),
        ...
        ce.extend({
            ...
            get: function (e, t) {
                ...
                var n = e.style, i = e.currentStyle, r = ce.isNumeric(t) ? "alpha(opacity=" + 100 * t + ")" : "",
        ...
        var vt, yt, bt = /^(?:toggle|show|hide)$/, wt = new RegExp("^(?:([+-])=|)(" + Me + ")([a-z%]*)$", "i"),
            xt = /queueHooks$/, Ct = [H], Tt = {
                "*": [function (e, t) {
                    var n = this.createTween(e, t), i = n.cur(), r = wt.exec(t),
                        o = r && r[3] || (ce.cssNumber[e] ? "" : "px"),
                        a = (ce.cssNumber[e] || "px" !== o && +i) && wt.exec(ce.css(n.elem, e)), s = 1, c = 20;
                    if (a && a[3] !== o) {
                        o = o || a[3], r = r || [], a = +i || 1;
        ...
        ce.Animation = ce.extend(U, {
            ...
            fadeTo: function (e, t, n, i) {
                ...
                return e !== !1 && (e = e || "fx"), this.each(function () {
                    var t, n = ce._data(this), i = n[e + "queue"], r = n[e + "queueHooks"], o = ce.timers,
                        a = i ? i.length : 0;
        ...
        var _t, Et, St = ce.expr.attrHandle, At = /^(?:checked|selected)$/i, It = ae.getSetAttribute, Mt = ae.input;
        ce.fn.extend({
            attr: function (e, t) {
            ...
            attr: function (e, t, n) {
                ...
                if (o && 1 === e.nodeType) for (; n = o[r++];) i = ce.propFix[n] || n, ce.expr.match.bool.test(n) ? Mt && It || !At.test(n) ? e[i] = !1 : e[ce.camelCase("default-" + n)] = e[i] = !1 : ce.attr(e, n, ""), e.removeAttribute(It ? n : i)
            }, attrHooks: {
                type: {
                    set: function (e, t) {
        ...
        var Nt = /^(?:input|select|textarea|button|object)$/i, Lt = /^(?:a|area)$/i;
        ce.fn.extend({
            prop: function (e, t) {
        ...
        ce.fn.extend({
            addClass: function (e) {
                ...
                if (l) for (t = (e || "").match(Te) || []; c > s; s++) if (n = this[s], i = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace($t, " ") : " ")) {
        ...
        var Bt, Ot, Pt = /#.*$/, Ht = /([?&])_=[^&]*/, Jt = /^(.*?):[ \t]*([^\r\n]*)\r?$/gm,
            Ut = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Ft = /^(?:GET|HEAD)$/, qt = /^\/\//,
            zt = /^([\w.+-]+:)(?:\/\/(?:[^\/?#]*@|)([^\/?#:]*)(?::(\d+)|)|)/, Wt = {}, Gt = {}, Yt = "*/".concat("*");
        try {
            Ot = location.href
        } catch (Qt) {
        ...
        Bt = zt.exec(Ot.toLowerCase()) || [], ce.extend({
            ...
            ajax: function (e, t) {
                ...
                var i, r, o, a, s, c, l, u, d = ce.ajaxSetup({}, t), f = d.context || d,
                    p = d.context && (f.nodeType || f.jquery) ? ce(f) : ce.event, h = ce.Deferred(),
                    g = ce.Callbacks("once memory"), m = d.statusCode || {}, v = {}, y = {}, b = 0, w = "canceled",
                    x = {
        ...
        ce.ajaxSetup({
            ...
            var r, o, a,
                s = e.jsonp !== !1 && (an.test(e.url) ? "url" : "string" == typeof e.data && !(e.contentType || "").indexOf("application/x-www-form-urlencoded") && an.test(e.data) && "data");
...
// var str = multiline(function() {/*!@tpl
    ...
    !function (e) {
        ...
        e.fn.modal = function (n) {
            ...
            var n = e(this), i = n.attr("href"), r = e(n.attr("data-target") || i && i.replace(/.*(?=#[^\s]+$)/, "")),
    ...
    !function () {
        var e = document.all && !document.addEventListener, t = n(8);
        e && ($("body").append(t).addClass("lt-IE8"), $("#J_modalUpdateBrowser").modal({show: !0, backdrop: "static"}))
    }()
}, function (e, t) {
    e.exports = function (e) {
    ...
    MI.form = function () {
        function e() {
            function e() {
                r.each(function () {
                    var e = $(this), t = e.closest(".form-section"), n = e.siblings("label");
    ...
    MI.alert = function (e) {
        var t, i, r = {msg: "温馨提示", isConfirm: !1, onCancel: $.noop, onConfirm: $.noop}, o = $.extend(r, e), a = n(14),
            s = $("#J_miAlert");
    ...
    MI.setLoginInfo = {
        ...
        updateDom: function (e) {
            var t, n, i = this.data.userName || e, r = MI.GLOBAL_CONFIG.staticSite || "//static.mi.com",
                o = $("#J_userInfo"),
    ...
    (function (r) {
        (function () {
            ...
            function s(e, t, n) {
                var i = t && n || 0, r = t || [];
                e = e || {};
                var o = null != e.clockseq ? e.clockseq : b, s = null != e.msecs ? e.msecs : (new Date).getTime(),
                    c = null != e.nsecs ? e.nsecs : x + 1, l = s - w + (c - x) / 1e4;
            ...
            var v = l(), y = [1 | v[0], v[1], v[2], v[3], v[4], v[5]], b = 16383 & (v[6] << 8 | v[7]), w = 0, x = 0,
                C = c;
    ...
    !function (e) {
        ...
        var o = "undefined" != typeof Uint8Array ? Uint8Array : Array, a = "+".charCodeAt(0), s = "/".charCodeAt(0),
            c = "0".charCodeAt(0), l = "a".charCodeAt(0), u = "A".charCodeAt(0), d = "-".charCodeAt(0),
            f = "_".charCodeAt(0);
        e.toByteArray = n, e.fromByteArray = r
    }(t)
}, function (e, t) {
    t.read = function (e, t, n, i, r) {
        var o, a, s = 8 * r - i - 1, c = (1 << s) - 1, l = c >> 1, u = -7, d = n ? r - 1 : 0, f = n ? -1 : 1,
            p = e[t + d];
        ...
        var a, s, c, l = 8 * o - r - 1, u = (1 << l) - 1, d = u >> 1,
            f = 23 === r ? Math.pow(2, -24) - Math.pow(2, -77) : 0, p = i ? 0 : o - 1, h = i ? 1 : -1,
            g = 0 > t || 0 === t && 0 > 1 / t ? 1 : 0;
    ...
    MI.miniCart = function () {
        ...
        var a = $("#J_miniCartTrigger"), s = $("#J_miniCartMenu"),
            c = '<div class="loading"><div class="loader"></div></div>', l = null;
        return {init: o}
    }()
}, function (e, t, n) {
    MI.message = {
        ...
        updateDom: function () {
            var e = this, t = MI.GLOBAL_CONFIG.orderSite + "/message/list",
    ...
    n(27), jQuery(function (e) {
        ...
        function i(t) {
            var i = n(29), r = e(i(t)), a = e("#J_navCategory");
    ...
    !function (e) {
        function t(t) {
            ...
            function c() {
                ...
                var n = d.offset(), i = {x: n.left, y: n.top - u.tolerance}, r = {x: n.left + d.outerWidth(), y: i.y},
                    o = {x: n.left, y: n.top + d.outerHeight() + u.tolerance}, a = {x: n.left + d.outerWidth(), y: o.y},
    ...
    e.exports = function (e) {
        ...
        if (n) for (var i, r = -1, o = n.length - 1; o > r;) {
            ...
            var a = i.right;
            if (a) for (var s, c = -1, l = a.length - 1; l > c;) s = a[c += 1], t += " <li", s.is_buy && (t += ' class="star-goods"'), t += '> <a class="link" href="' + s.url + '"><img class="thumb" src="//i1.mifile.cn/f/i/2014/cn/placeholder-40.png" data-src="' + s.img + '?width=80&height=80" width="40" height="40" alt="" /><span class="text">' + s.title + "</span></a> ", s.is_buy && (t += '<a class="btn btn-line-primary btn-small btn-buy" href="' + s.buy_url + '">选购</a>'), t += " </li> ";
            t += " </ul> </div> </li> "
        }
        return t += " </ul></div>"
    }
    ...
    !function (e) {
        function t(e) {
            for (var t = "", n = 0, i = e.length; i > n; n += 1) {
                var r, o;
                "object" == typeof e[n] ? (r = e[n].Key.replace(f, '<span class="keyword">' + f + "</span> "), o = e[n].Rst ? '<span class="result">约有' + e[n].Rst + "件</span>" : "", t += '<li data-key="' + e[n].Key + '"><a href="//localhost:83/search/searchProduct?uname={user}&keyWord=' + encodeURIComponent(e[n].Key) + '">' + r + o + "</a></li>") : (r = e[n].replace(f, '<span class="keyword">' + f + "</span> "), o = "", t += '<li data-key="' + e[n] + '"><a href="//localhost:83/search/searchProduct?keyWord=' + encodeURIComponent(e[n]) + '">' + r + o + "</a></li>")
            }
        ...
        function o() {
            a.on("submit", function () {
                var t = e.trim(c.val());
                return "" !== t && (t = t.replace(/[\-_'=+|\\\/]/g, " "), window.location.href = MI.GLOBAL_CONFIG.searchSite + "?keyWord=" + encodeURIComponent(t)), !1
            })
        }

        var a = e("#J_searchForm"),
            s = e('<div id="J_keywordList" class="keyword-list hide"><ul class="result-list"></ul></div>'),
            c = a.find("#search"), l = a.find(".search-hot-words"), u = {}, d = 200, f = null, p = 0, h = 0;
        if (a.length) {
            c = a.find("#search");
            try {
    ...
    n(32), MI.addShopCart = function (e, t, n, i) {
        if (e && "function" == typeof t) {
            ...
            $.ajax({
                url: r, dataType: "jsonp", jsonp: "jsonpcallback", data: i ? i : "", error: function (e, t, n) {
                    var o = i ? i : {};
        ...
        if (e) {
            var t = $.extend({}, e), i = $.noop, r = $("#J_modalAddCartCaptcha"), o = "", a = n(33);
        ...
        $.extend(t, e || {}), $(document).off(".bigtap").on("click.bigtap", t.obj, function () {
            var e = $(this).attr("data-gid"), n = $(this).attr("data-disabled") || "false",
                i = $(this).attr("data-package") || "false", r = $.cookie("cUserId") || $.cookie("userId"),
    ...
    MI.miDragCaptcha = function () {
        ...
        constructor: MI.miDragCaptcha, init: function (e) {
            ...
            var t = e.createImg(e.options.captchaData.img1), n = e.createImg(e.options.captchaData.img0),
            ...
            if (t.length) {
                var n = t.find("#J_dragCaptchaHandle"), i = t.find("#J_dragCaptchaPiece"),
                    r = $("#J_dragCaptchaControlMsg"), o = 0, a = 0, s = 0, c = 0, l = !1;
            ...
            var e = this, t = $("#J_dragCaptchaHandle"), n = {x: t.offset().left, y: t.offset().top}, i = {x: 0, y: 0},
                r = (new Date).getTime();
            ...
            if (e.options.line.length) {
                var t = $(e.options.captchaWrapper).find("#J_dragCaptchaHandle"),
                    n = $(e.options.captchaWrapper).find("#J_dragCaptchaPiece"), i = $("#J_dragCaptchaControlMsg"),
                    r = $("#J_dragCaptchaLoadingBackdrop"), o = $("#J_dragCaptchaLoading");
        ...
        init: function (e) {
            ...
            if ("1" === e.config.modeType) {
                ...
                error: function (n, i, r) {
                    var o = {product: e.config.gid, m: 1, storage: e.config.storage};
            ...
            var t = this, n = $("#J_bigtapModeTip"), i = "请输入正确的验证码", r = "验证超时，请重新验证", o = "正在验证答案，请稍后...", a = "",
                s = $("#J_bigtapModeInput"), c = $("#J_bigtapModeSubmit");
            a = e ? e : $.trim(s.val());
            ...
            $.ajax({
                ...
                success: function (t) {
                    var n = t.status, i = n[e.config.gid].hdurl,
                        r = n[e.config.gid].hdstart === !1 && n[e.config.gid].hdstop === !0 ? !0 : !1,
                        o = t.d22a51 ? 1e3 * t.d22a51 : 5e3, a = n[e.config.gid].tips;
            ...
            $.ajax({
                ...
                error: function (i, r, o) {
                    var a = {source: t.config.sourceVal, token: e};
            ...
            var t = this, n = "//rec.www.mi.com/bigtap/get", i = __webpack_require__(36), r = "",
                o = __webpack_require__(37),
                a = {title: "很遗憾，你本次未能买到<br>人真是太多了", desc: "别灰心，可以关注小米商城app、微博，或者微信，<br>我们会及时告知你下一轮的开售时间。"},
                s = function () {
            ...
            var e = this, t = 0, n = $(e.config.modalQueue).find(".queue-tip"),
                i = $(e.config.modalQueue).find(".poster"), r = n.length, o = function () {
